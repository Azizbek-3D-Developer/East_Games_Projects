...
from .custom_routes.version_route import router as project_version_route
...
from .collection_documents_route import router as user_collection_documents_route
from .custom_routes.huffman_route import router as user_huffman_route
...
api_router.include_router(user_collection_documents_route)
api_router.include_router(project_version_route)
api_router.include_router(user_huffman_route)
